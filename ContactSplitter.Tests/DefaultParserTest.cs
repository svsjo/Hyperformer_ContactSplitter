...
public class DefaultParserTest
{
    ...
    [InlineData("Frau Dr. med. Petra Schmitz-Hoffmann", "Frau Doktorin", "Dr. med.", "Sehr geehrte Frau Doktorin", "Petra", "Schmitz-Hoffmann", "F")]
    ...
    [InlineData("Frau Dipl.-Ing. Karin Müller-Lüdenscheidt", "Frau Diplom-Ingenieurin", "Dipl.-Ing.", "Sehr geehrte Frau Diplom-Ingenieurin", "Karin", "Müller-Lüdenscheidt", "F")]
    ...
    [InlineData("Frau Prof. Dr. rer. nat. habil. Gisela Riedel-Hoffmann", "Frau Professorin", "Prof. Dr. rer. nat. habil.", "Sehr geehrte Frau Professorin", "Gisela", "Riedel-Hoffmann", "F")]
    ...
    [InlineData("Dr. rer. nat. Ingrid Schulz", "Doktoren und Doktorinnen", "Dr. rer. nat.", "Sehr geehrte Doktoren und Doktorinnen", "Ingrid", "Schulz", "D")]
    ...
    [InlineData("Frau Dr. iur. Claudia Schuster-Müller", "Frau Doktorin", "Dr. iur.", "Sehr geehrte Frau Doktorin", "Claudia", "Schuster-Müller", "F")]
    [InlineData("Herr Dr. rer. nat. habil. Franz Bauer", "Herr Doktor", "Dr. rer. nat. habil.", "Sehr geehrter Herr Doktor", "Franz", "Bauer", "M")]
    [InlineData("Frau Prof. Dr. rer. pol. habil. Anna Schmidt-Weiß", "Frau Professorin", "Prof. Dr. rer. pol. habil.", "Sehr geehrte Frau Professorin", "Anna", "Schmidt-Weiß", "F")]
