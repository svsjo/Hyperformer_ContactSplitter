...
public class GptParserTest
{
    ...
    [InlineData("Frau Prof. Dr. rer. nat. Maria von Leuthäuser-Schnarrenberger", "Frau Professorin", "Prof. Dr. rer. nat.", "Sehr geehrte Frau Professor", "Maria", "von Leuthäuser-Schnarrenberger", "F")]
    ...
    [InlineData("Frau Prof. Dr. rer. nat. habil. Gisela Riedel-Hoffmann", "Frau Professorin", "Prof. Dr. rer. nat. habil.", "Sehr geehrte Frau Professor", "Gisela", "Riedel-Hoffmann", "F")]
    ...
    [InlineData("Frau Prof. Dr. rer. pol. habil. Anna Schmidt-Weiß", "Frau Professorin", "Prof. Dr. rer. pol. habil.", "Sehr geehrte Frau Professor", "Anna", "Schmidt-Weiß", "F")]
