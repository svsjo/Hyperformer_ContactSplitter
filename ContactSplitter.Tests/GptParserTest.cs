...
public class GptParserTest
{
    ...
    [InlineData("Herr Dr. Sandro Gutmensch", "Herr Doktor", "Dr.", "Sehr geehrter Herr Doktor", "Sandro", "Gutmensch",
        "M")]
    [InlineData("Professor Heinreich Freiherr vom Wald", "Herr Professor", "Professor", "Sehr geehrter Herr Professor",
        "Heinreich", "Freiherr vom Wald", "M")]
    ...
    [InlineData("Dr. Russwurm, Winfried", "Herr Doktor", "Dr.", "Sehr geehrter Herr Doktor", "Winfried", "Russwurm",
        "M")]
    ...
    [InlineData("Frau Dr. med. Petra Schmitz-Hoffmann", "Frau Doktor", "Dr. med.", "Sehr geehrte Frau Doktor", "Petra",
        "Schmitz-Hoffmann", "F")]
    ...
    [InlineData("Frau Dipl.-Ing. Karin Müller-Lüdenscheidt", "Frau Diplom-Ingenieur", "Dipl.-Ing.",
        "Sehr geehrte Frau Diplom-Ingenieur", "Karin", "Müller-Lüdenscheidt", "F")]
    ...
    [InlineData("Dr. rer. nat. Schulz, Ingrid", "Frau Doktor", "Dr. rer. nat.", "Sehr geehrte Frau Doktor", "Ingrid",
        "Schulz", "F")]
    [InlineData("Herr Dipl.-Ing. Michael Bauer", "Herr Diplom-Ingenieur", "Dipl.-Ing.",
        "Sehr geehrter Herr Diplom-Ingenieur", "Michael", "Bauer", "M")]
    [InlineData("Frau Dr. iur. Claudia Schuster-Müller", "Frau Doktor", "Dr. iur.", "Sehr geehrte Frau Doktor",
